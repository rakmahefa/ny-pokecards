...
if apply_event=true {
	...
	if event_kind=ref_event_levelup and card_id_in_space[0]!=-1 {
		...
		card_id_in_space[0].card_id=555 or card_id_in_space[0].card_id=641 or card_id_in_space[0].card_id=642 or card_id_in_space[0].card_id=645 or card_id_in_space[0].card_id=646 or
		card_id_in_space[0].card_id=647 or card_id_in_space[0].card_id=648) and card_id_in_space[0].card_innate>0 {
			...
			else if card_id_in_space[0].card_id=487 or card_id_in_space[0].card_id=492 or card_id_in_space[0].card_id=555 or
			card_id_in_space[0].card_id=641 or card_id_in_space[0].card_id=642 or card_id_in_space[0].card_id=645 or card_id_in_space[0].card_id=647 or card_id_in_space[0].card_id=648 {
				//giratina, shaymin, darmanitan, tornadus, thundurus, landorus, keldeo, meloetta (0-500)
				card_id_in_space[0].card_form_value+=500; }
			else if card_id_in_space[0].card_id=646 {
				//kyurem (0-500-750)
				if card_id_in_space[0].card_form_value<250 { card_id_in_space[0].card_form_value=250; }
				card_id_in_space[0].card_form_value+=250;
			}
