	...
	do {
		...
		if random_card=true and enemy_randomizer=false {
			if random_group_chance<1 { //0.01% secret card
				...
				var random_id_chance=irandom(99); if random_id_chance<40 { allow_id_starter=true; } //40% starter allowed
			...
			//
			var random_id_chance=irandom(999); if (random_id_chance<5 or ob_main.secret_code=true) and card_id<=normal_poke_id_max { card_shiny=true; } //0.5% shiny, same as in ob_event
		...
		//————————————————————————————————————————————————————————————————————————————————————————————————————
			...
			if random_group_chance<500 { //5% environment card
				...
				var random_id_chance=irandom(99); if random_id_chance<10 { allow_id_baby=true; } //10% baby allowed
			}
			//
