...
if card_cat=0 and card_face=true and in_view=true {
	...
	if card_nickname!="" {
		...
		else if (string_lower(card_nickname)="daffy" or string_lower(card_nickname)="dapi") and card_id=197 { secret_sprite_x=1; secret_sprite_y=12; } //umbreon
		else if (string_lower(card_nickname)="side b" or string_lower(card_nickname)="sideb" or string_lower(card_nickname)="sidey") and card_id=403 { secret_sprite_x=2; secret_sprite_y=12; } //shinx
		else if string_lower(card_nickname)="yuki" and card_id=151 { secret_sprite_x=3; secret_sprite_y=12; } //mew
		else if (string_lower(card_nickname)="sunset" or string_lower(card_nickname)="sunny") and card_id=448 { secret_sprite_x=4; secret_sprite_y=12; } //lucario
		...
		else if (string_lower(card_nickname)="jessico" or string_lower(card_nickname)="jess") and card_id=162 { secret_sprite_x=11; secret_sprite_y=12; } //furret
		...
		else if (string_lower(card_nickname)="koby" or string_lower(card_nickname)="kobault" or string_lower(card_nickname)="kris" or string_lower(card_nickname)="kobito") and card_id=417 { secret_sprite_x=13; secret_sprite_y=12; } //pachirisu
		else if (string_lower(card_nickname)="nate" or string_lower(card_nickname)="papita") and card_id=585 { secret_sprite_x=14; secret_sprite_y=12; } //deerling
		else if (string_lower(card_nickname)="blue" or string_lower(card_nickname)="berry" or string_lower(card_nickname)="blueberry") and card_id=157 { secret_sprite_x=15; secret_sprite_y=12; } //typhlosion
		...
		else if (string_lower(card_nickname)="milachu" or string_lower(card_nickname)="mila") and card_id=025 { secret_sprite_x=3; secret_sprite_y=11; } //pikachu
		...
		else if (string_lower(card_nickname)="floofie" or string_lower(card_nickname)="sweets" or string_lower(card_nickname)="sweetness" or string_lower(card_nickname)="batata") and card_id=133 { secret_sprite_x=6; secret_sprite_y=11; } //eevee
		else if (string_lower(card_nickname)="ash" or string_lower(card_nickname)="scarlet") and card_id=038 { secret_sprite_x=7; secret_sprite_y=11; } //ninetales
		else if (string_lower(card_nickname)="white" or string_lower(card_nickname)="whitegame") and card_id=471 { secret_sprite_x=8; secret_sprite_y=11; } //glaceon
		else if (string_lower(card_nickname)="chonky" or string_lower(card_nickname)="chonkyfox" or string_lower(card_nickname)="chonky fox") and card_id=133 { secret_sprite_x=9; secret_sprite_y=11; } //eevee
	}
	//
