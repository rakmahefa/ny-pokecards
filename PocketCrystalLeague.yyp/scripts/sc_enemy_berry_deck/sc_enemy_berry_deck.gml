...
//
if ob_main.stats_league_won>0 and (ob_main.playing_gym=true or ob_main.playing_elite=true) { enemycard_berrydeck_total=round(enemycard_berrydeck_total*2.5); } //+150%
else if ob_main.playing_gym=true { enemycard_berrydeck_total=round(enemycard_berrydeck_total*2); } //+100%
else if ob_main.playing_elite=true { enemycard_berrydeck_total=round(enemycard_berrydeck_total*2.25); } //+125%
else if ob_main.playing_champion=true { enemycard_berrydeck_total=round(enemycard_berrydeck_total*2.5); } //+150%
else if ob_main.playing_tutorial=false and argument0=100 { enemycard_berrydeck_total=round(enemycard_berrydeck_total*1.75); } //+75% (ACE TRAINER)
...
else if ob_main.playing_tutorial=false and argument0!=100 and argument0!=150 { enemycard_berrydeck_total=round(enemycard_berrydeck_total*1.5); } //+50%
//
var i=0;
