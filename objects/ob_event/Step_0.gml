...
if apply_event=true {
	...
	if event_kind=ref_event_levelup and card_id_in_space[0]!=-1 {
		...
		card_id_in_space[0].card_id=641 or card_id_in_space[0].card_id=642 or card_id_in_space[0].card_id=645 or card_id_in_space[0].card_id=646 or card_id_in_space[0].card_id=647 or
		card_id_in_space[0].card_id=648) and card_id_in_space[0].card_innate>0 {
